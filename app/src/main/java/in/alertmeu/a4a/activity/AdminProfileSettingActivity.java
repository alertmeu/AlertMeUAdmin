...
public class AdminProfileSettingActivity extends AppCompatActivity {
    ...
    LinearLayout inviteMsg, btnHelp, btnsendNotifyTu, btnsendNotifyTb, myPlaces, myAccount, myRequestMoney, addModifyCat, addModifyMoney;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsendNotifyTu = (LinearLayout) findViewById(R.id.btnsendNotifyTu);
        btnsendNotifyTb = (LinearLayout) findViewById(R.id.btnsendNotifyTb);
        ...
        btnsendNotifyTu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminProfileSettingActivity.this, SentNotificationBNUActivity.class);
                intent.putExtra("apptype", "1");
                startActivity(intent);
            }
        });
        btnsendNotifyTb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminProfileSettingActivity.this, SentNotificationBNUActivity.class);
