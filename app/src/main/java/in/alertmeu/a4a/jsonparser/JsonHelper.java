...
public class JsonHelper {
   ...
   private ArrayList<SendNotificationModelDAO> sendNotificationModelDAOArrayList = new ArrayList<SendNotificationModelDAO>();
    private SendNotificationModelDAO sendNotificationModelDAO;
  ...
  public ArrayList<ImageModel> parseImagePathList(String ListResponse) {
    ...
    public ArrayList<SendNotificationModelDAO> parseFCMIdsList(String ListResponse) {
        // TODO Auto-generated method stub
        Log.d("scheduleListResponse", ListResponse);
        try {
            JSONObject jsonObject = new JSONObject(ListResponse);
            ...
            if (!jsonObject.isNull("dataList")) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    JSONObject object = jsonArray.getJSONObject(i);
                    sendNotificationModelDAO = new SendNotificationModelDAO();
                    sendNotificationModelDAO.setId(object.getString("id"));
                    sendNotificationModelDAO.setFcm_id(object.getString("fcm_id"));
                    sendNotificationModelDAO.setCountry_code(object.getString("country_code"));
                    sendNotificationModelDAO.setName(object.getString("name"));
                    sendNotificationModelDAO.setImagepath(object.getString("imagepath"));
                    sendNotificationModelDAO.setLatitude(object.getString("latitude"));
                    sendNotificationModelDAO.setLongitude(object.getString("longitude"));
                    sendNotificationModelDAOArrayList.add(sendNotificationModelDAO);
                }
            }
        ...
        return sendNotificationModelDAOArrayList;
    }
