...
public class Config {
    ...
    public static final String URL_GETALLUBFCMIDBYADMIN = BASE_URL + "user/getAllUBFCMIDByAdmin";
    public static final String URL_SENDCUSTUMNOTIFICATIONUSERDATA = BASE_URL + "user/sendCustumNotificationUserData";
    public static final String URL_SENDCUSTUMNOTIFICATIONBUSINESSDATA = BASE_URL + "user/sendCustumNotificationBusinessData";
